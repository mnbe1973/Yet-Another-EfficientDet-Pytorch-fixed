...
img_path = '/content/Yet-Another-EfficientDet-Pytorch-fixed/test/img.png'
...
state = torch.load(f'/content/Yet-Another-EfficientDet-Pytorch-fixed/efficientdet-d{compound_coef}.pth',
                   map_location=device,
                   weights_only=True)
...
def display(preds, imgs, imshow=True, imwrite=False):
    for i in range(len(imgs)):
        ...
        if imwrite:
            cv2.imwrite(f'/content/Yet-Another-EfficientDet-Pytorch-fixed/test/img_inferred_testy3_d{compound_coef}_this_repo_{i}.jpg', imgs[i])
